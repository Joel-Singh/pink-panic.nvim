...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    sym '@text' { TSText }, -- Comment
    sym '@text.literal' { TSText }, -- Comment
    -- sym"@text.reference"    { }, -- Identifier
    sym '@text.title' { TSStrong }, -- Title
    sym '@text.uri' { TSURI }, -- Underlined
    -- sym"@text.underline"    { }, -- Underlined
    -- sym"@text.todo"         { }, -- Todo
    sym '@comment' { TSComment }, -- Comment
    sym '@punctuation' { TSPunctBracket }, -- Delimiter
    sym '@punctuation.delimiter' { TSPunctBracket }, -- Delimiter
    sym '@constant' { TSConstant }, -- Constant
    sym '@constant.builtin' { TSConstBuiltin }, -- Special
    -- sym"@constant.macro"    { }, -- Define
    sym '@define' { TSKeywordFunction }, -- Define
    -- sym"@macro"             { }, -- Macro
    sym '@string' { TSCharacter }, -- String
    sym '@string.escape' { TSStringEscape }, -- SpecialChar
    sym '@string.special' { TSConstructor }, -- SpecialChar
    sym '@character' { TSCharacter }, -- Character
    sym '@character.special' { TSCharacterSpecial }, -- SpecialChar
    sym '@number' { TSFloat }, -- Number
    sym '@boolean' { TSBoolean }, -- Boolean
    sym '@float' { TSFloat }, -- Float
    sym '@function' { TSFunction }, -- Function
    sym '@function.builtin' { TSFuncBuiltin }, -- Special
    -- sym"@function.macro"    { }, -- Macro
    sym '@parameter' { TSParameter }, -- Identifier
    sym '@method' { TSMethod }, -- Function
    sym '@field' { TSField }, -- Identifier
    -- sym"@property"          { }, -- Identifier
    sym '@constructor' { TSPunctBracket }, -- Special
